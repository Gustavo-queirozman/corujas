...
class Payload
{
    ...
    /**
     * Metodo responsável por definir o valor de $pixKey
     * @param string $pixKey
     **/
    ...
    /**
     * Responsavel por retornar um valor completo de um objeto do payload
     * @param string $id
     * @param string $value
    ...
    /**
     * Metodo responsável por retornar os valores completos da informação da conta
     * @return string
     **/
